    ...
    public partial class GeneratingSetTestReportModal : System.Web.UI.Page
    {
        ...
        public void GetDetailswithId()
        {
            try
            {
                ...
                if (isSiteOwnerCase)
                {
                    ...
                    txtCapacityType_SO.Text = ds.Tables[0].Rows[0]["GeneratingSetCapacityType"].ToString();
                    txtCapacity_SO.Text = ds.Tables[0].Rows[0]["GeneratingSetCapacity"].ToString();
                    txtSerialNoOfGenerator_SO.Text = ds.Tables[0].Rows[0]["SerialNumbrOfAcGenerator"].ToString();
                    txtGeneratingSetType_SO.Text = ds.Tables[0].Rows[0]["GeneratingSetType"].ToString();
        ...
        protected void btnVerify_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
               ...
               // ScriptManager.RegisterStartupScript(this, this.GetType(), "showalert", "alert('An Error Occured, Error :')" + ex, true);
